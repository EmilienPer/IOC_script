...
class TestParse(unittest.TestCase):
    ...
    def test_well_formed_data(self):
        ...
        self.assertEqual(parser.parse(), {'unclassified': [['']], 'FileScan': [
            {'file_path': '/usr/local/share/doc/impacket/testcases/SMB_RPC/test_mimilib.py', 'score': '70',
             'log_type': 'UNKNOWN', 'size': '5073', 'first_byte': '2323232323232323232323232323232323232323',
             'md5': '63c6e93e5e5e3947ebcc95664ac47962', 'sha1': '452f739314d65daa1ec067e341f896e319121b2e',
             'sha256': 'a3db0756306658850b99425cc78c42eb90b2f53b8ed7f793188133cb7ebe02d0',
             'created': 'Thu Oct 21 15:05:45 2021', 'modified': 'Thu Oct 21 15:05:45 2021',
             'accessed': 'Thu Dec  1 18:56:42 2022', 'reasons': [{'hash': 'Mimikatz_Memory_Rule_1',
                                                                  ...
                                                                  'reason': 'Yara Rule'}]},
            {'file_path': '/usr/local/bin/wmiexec.py', 'score': '130', 'log_type': 'UNKNOWN', 'size': '16458',
             'first_byte': '23212f7573722f62696e2f707974686f6e0a2320', 'md5': '6a91aa180468eeb958cebc40510186ce',
             'sha1': 'd1697c7099d505707c285d66aefa13319cc444b0',
             'sha256': '0dc6fc4902fc64083a977fd82596cd99a6983f6458cbfc8c92a532bc8384a8f8',
             'created': 'Thu Oct 21 15:05:45 2021', 'modified': 'Thu Oct 21 15:05:45 2021',
             'accessed': 'Thu Dec  1 18:56:42 2022', 'reasons': [
                {'pattern': '/wmiexec', 'description': 'Known Bad / Dual use classics',
                 'reason': 'File Name IOC matched'}, {'pattern': '/wmiexec\\.py',
                                                      'description': 'Impacket default file name used for tools in the examples folder of the project https://github.com/SecureAuthCorp/impacket',
                                                      'reason': 'File Name IOC matched'}]},
            {'file_path': '/usr/local/bin/esentutl.py', 'score': '70', 'log_type': 'UNKNOWN', 'size': '3208',
             'first_byte': '23212f7573722f62696e2f707974686f6e0a2320', 'md5': '25e18d62f7aa991a15db679b9036b977',
             'sha1': 'a89009afd078d63f24cbb6886387781a1e0ae68c',
             'sha256': '6efdedfe41c0d762cc0183a8568e09f21b4452aec3beb12e2f314f5f83c9fb34',
             'created': 'Thu Oct 21 15:05:45 2021', 'modified': 'Thu Oct 21 15:05:45 2021',
             'accessed': 'Thu Dec  1 18:56:43 2022', 'reasons': [{'pattern': '/esentutl\\.py',
                                                                  'description': 'Impacket default file name used for tools in the examples folder of the project https://github.com/SecureAuthCorp/impacket',
                                                                  'reason': 'File Name IOC matched'}]},
            {'file_path': '/usr/local/bin/smbrelayx.py', 'score': '220', 'log_type': 'UNKNOWN', 'size': '52990',
             'first_byte': '23212f7573722f62696e2f707974686f6e0a2320', 'md5': 'e31fda06426247fd9bf6fd828ff0447f',
             'sha1': '57b2fa93f60921af2753c6f8bf9b2a8267d5fd32',
             'sha256': '2f6fa5f1e9544b9f6dc17e49bb11ae479cabc3d079d70045fc64b07b264ea8e0',
             'created': 'Thu Oct 21 15:05:45 2021', 'modified': 'Thu Oct 21 15:05:45 2021',
             'accessed': 'Thu Dec  1 18:56:43 2022', 'reasons': [
                {'pattern': '/smbrelayx', 'description': 'Relay Attack Tool Names', 'reason': 'File Name IOC matched'},
                {'pattern': '/smbrelayx\\.py',
                 'description': 'Impacket default file name used for tools in the examples folder of the project https://github.com/SecureAuthCorp/impacket',
                 'reason': 'File Name IOC matched'}]},
            {'file_path': '/usr/local/bin/wmipersist.pyc', 'score': '70', 'log_type': 'UNKNOWN', 'size': '7974',
             'first_byte': '03f30d0aa9657161630000000000000000080000', 'md5': '336ebc5563aa7e558f4d7d432194b909',
             'sha1': 'cd0b2d602d79e96f6e0bf07d227c37ceefed321c',
             'sha256': '161e10bbfb90b9b2c6488c680fa687cb120a35fd487aba97453c3399269f29aa',
             'created': 'Thu Oct 21 15:05:45 2021', 'modified': 'Thu Oct 21 15:05:45 2021',
             'accessed': 'Thu Dec  1 18:56:43 2022', 'reasons': [{'pattern': '/wmipersist\\.py',
                                                                  'description': 'Impacket default file name used for tools in the examples folder of the project https://github.com/SecureAuthCorp/impacket',
                                                                  'reason': 'File Name IOC matched'}]},
            {'file_path': '/usr/local/bin/samrdump.pyc', 'score': '70', 'log_type': 'UNKNOWN', 'size': '9141',
             'first_byte': '03f30d0aa96571616300000000000000000c0000', 'md5': 'a4dd870ad29cdb1a825b8e4de968927c',
             'sha1': 'dcd1a5183732669d333f8231b5ac88577a56fe9c',
             'sha256': '36437d49fbeef8958ce9cac27aa48481498040cd95072804f59b3d9bcabd8788',
             'created': 'Thu Oct 21 15:05:45 2021', 'modified': 'Thu Oct 21 15:05:45 2021',
             'accessed': 'Thu Dec  1 18:56:43 2022', 'reasons': [{'pattern': '/samrdump\\.py',
                                                                  'description': 'Impacket default file name used for tools in the examples folder of the project https://github.com/SecureAuthCorp/impacket',
                                                                  'reason': 'File Name IOC matched'}]},
            {'file_path': '/usr/local/bin/lookupsid.py', 'score': '70', 'log_type': 'UNKNOWN', 'size': '6705',
             'first_byte': '23212f7573722f62696e2f707974686f6e0a2320', 'md5': 'b114be8855a21000c770299a20082e69',
             'sha1': '3582a6ae52a070378c139c93b79d34faee57d2a8',
             'sha256': '6bb0633e0467d9290994974d0b43d60ca7dc9b107d65cfd1d1c36c93045329b3',
             'created': 'Thu Oct 21 15:05:45 2021', 'modified': 'Thu Oct 21 15:05:45 2021',
             'accessed': 'Thu Dec  1 18:56:43 2022', 'reasons': [{'pattern': '/lookupsid\\.py',
                                                                  'description': 'Impacket default file name used for tools in the examples folder of the project https://github.com/SecureAuthCorp/impacket',
                                                                  'reason': 'File Name IOC matched'}]},
            {'file_path': '/usr/local/bin/secretsdump.py', 'score': '70', 'log_type': 'UNKNOWN', 'size': '17779',
             'first_byte': '23212f7573722f62696e2f707974686f6e0a2320', 'md5': 'b4270a553308664199874bbd72999ccf',
             'sha1': 'b541a0c349b14803e51be88c069d16b9d14e6192',
             'sha256': '9a54d529df28c8f5e2b0211aa694cf5cd279605a55ebdc42ee473088359f55c9',
             'created': 'Thu Oct 21 15:05:45 2021', 'modified': 'Thu Oct 21 15:05:45 2021',
             'accessed': 'Thu Dec  1 18:56:43 2022', 'reasons': [{'pattern': '/secretsdump\\.py',
                                                                  'description': 'Impacket default file name used for tools in the examples folder of the project https://github.com/SecureAuthCorp/impacket',
                                                                  'reason': 'File Name IOC matched'}]},
            {'file_path': '/usr/local/bin/rdp_check.py', 'score': '70', 'log_type': 'UNKNOWN', 'size': '23084',
             'first_byte': '23212f7573722f62696e2f707974686f6e0a2320', 'md5': '80a9eee2475ace913208186a2ce472bd',
             'sha1': '745e9d351d8456fe928554313e532334f0e62b51',
             'sha256': '2e175ba69ce41a41ff00a266c9a35f4e95f246a577b153d2499bf898d585ae35',
             'created': 'Thu Oct 21 15:05:45 2021', 'modified': 'Thu Oct 21 15:05:45 2021',
             'accessed': 'Thu Dec  1 18:56:43 2022', 'reasons': [{'pattern': '/rdp_check\\.py',
                                                                  'description': 'Impacket default file name used for tools in the examples folder of the project https://github.com/SecureAuthCorp/impacket',
                                                                  'reason': 'File Name IOC matched'}]},
            {'file_path': '/usr/local/bin/sniffer.py', 'score': '70', 'log_type': 'UNKNOWN', 'size': '2075',
             'first_byte': '23212f7573722f62696e2f707974686f6e0a2320', 'md5': '167580108df197cc14394b543242ce02',
             'sha1': '69c7c2375b20a90e15ecc2cf17d13cab3bb162c4',
             'sha256': '688a68729c11c10b9be298ea8691935d102398917d8dd314dd3559503c2d0bc6',
             'created': 'Thu Oct 21 15:05:45 2021', 'modified': 'Thu Oct 21 15:05:45 2021',
             'accessed': 'Thu Dec  1 18:56:43 2022', 'reasons': [{'pattern': '/sniffer\\.py',
                                                                  'description': 'Impacket default file name used for tools in the examples folder of the project https://github.com/SecureAuthCorp/impacket',
                                                                  'reason': 'File Name IOC matched'}]},
            {'file_path': '/usr/local/bin/ticketer.py', 'score': '70', 'log_type': 'UNKNOWN', 'size': '38609',
             'first_byte': '23212f7573722f62696e2f707974686f6e0a2320', 'md5': 'fa83ce367e5b61146cfb62b2002248bb',
             'sha1': 'd1ce9546338b9d391ef89e71768eb7f451e57454',
             'sha256': '83c5cd09e09bf6580bf4cd5d6f8329a06cfe8a6ee7a86fd1e7c0b7e259dd17d6',
             'created': 'Thu Oct 21 15:05:45 2021', 'modified': 'Thu Oct 21 15:05:45 2021',
             'accessed': 'Thu Dec  1 18:56:43 2022', 'reasons': [{'pattern': '/ticketer\\.py',
                                                                  'description': 'Impacket default file name used for tools in the examples folder of the project https://github.com/SecureAuthCorp/impacket',
                                                                  'reason': 'File Name IOC matched'}]}]})
